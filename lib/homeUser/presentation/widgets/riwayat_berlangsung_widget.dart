...
import 'package:baswara_app/homeUser/presentation/pages/detail_riwayat_berlangsung_page.dart';
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      DateFormat('d MMMM y')
                                          .format(state.data.data[i].createdAt),
